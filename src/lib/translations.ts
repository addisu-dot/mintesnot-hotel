...
export const translations = {
  EN: {
    ...
    exterior: {
      ...
      subtitle: "Experience the stunning architecture of Mintesnot Hotel, from our impressive night view under the stars to our beautiful afternoon ambiance.",
      nightView: "Mintesnot Hotel night view under the stars",
      mainBuilding: "Mintesnot Hotel main building exterior",
      afternoonView: "Mintesnot Hotel afternoon view",
      fromInside: "View from inside Mintesnot Hotel",
      signage: "Mintesnot Hotel signage",
      viewGallery: "View Gallery",
      galleryEyebrow: "Photo Gallery",
      galleryTitle: "Explore Our Exterior",
      gallerySubtitle: "A visual journey through the architectural beauty and surrounding landscapes of Mintesnot Hotel.",
      ctaTitle: "Experience It Yourself",
      ctaSubtitle: "Book your stay and witness the beauty of Mintesnot Hotel in person.",
  ...
  AM: {
    ...
    exterior: {
      eyebrow: "አርክቴክቸር እና ዲዛይን",
      title: "የውጪ እይታዎች",
      subtitle: "የምንተስኖት ሆቴል የተደራጀ አርክቴክቸርን ያስተውሉ - ከኮከብ ስር ያለው የሌሊት እይታ እስከ ያንሸብሽተኛው አረንጓዴ አካባቢ ድረስ።",
      nightView: "የምንተስኖት ሆቴል የሌሊት እይታ ከኮከብ ስር",
      mainBuilding: "የምንተስኖት ሆቴል ዋና ሕንፃ የውጪ እይታ",
      afternoonView: "የምንተስኖት ሆቴል የአረፍ ጊዜ እይታ",
      fromInside: "ከምንተስኖት ሆቴል ውስጥ የሚታይ እይታ",
      signage: "የምንተስኖት ሆቴል ስም",
      viewGallery: "ማስታወሻዎችን ይመልከቱ",
      galleryEyebrow: "ፎቶ ማስታወሻ",
      galleryTitle: "የውጪ እይታዎችን ያስሱ",
      gallerySubtitle: "የምንተስኖት ሆቴል የአርክቴክቸር ውበት እና የአካባቢ ውበቶች በማስታወሻዎች የሚገለጹ።",
      ctaTitle: "በእርግጥ ይሞክሩት",
      ctaSubtitle: "ቦታዎን ያስይዙ እና የምንተስኖት ሆቴል ውበትን በአይንዎ ይመልከቱ።",
